...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/ProtonDriveApps/sdk-swift/releases/download/0.17.0/CProtonDriveSDK.xcframework.zip",
            checksum: "3a99e70ef6bcc87d0e4cee2621a173878993f54fd066120dc6deda30ead49ae2"
        ),
        .target(
            name: "ProtonDriveSDK",
            dependencies: [
