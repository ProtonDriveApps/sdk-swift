...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/ProtonDriveApps/sdk-swift/releases/download/0.23.0-rust/CProtonDriveSDK.xcframework.zip",
            checksum: "61af86bf2ec10b12ca72b526bb720809cb853f8cd65d4bd9407400f4b7764f4b"
        ),
        .target(
            name: "ProtonDriveSDK",
            dependencies: [
