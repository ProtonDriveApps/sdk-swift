...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/ProtonDriveApps/sdk-swift/releases/download/0.20.0/CProtonDriveSDK.xcframework.zip",
            checksum: "592ea93f668dca5259dc2c4add6d77a24a625a690e9fd8023fd645116108ca31"
        ),
        .target(
            name: "ProtonDriveSDK",
            dependencies: [
