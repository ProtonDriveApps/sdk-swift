...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/ProtonDriveApps/sdk-swift/releases/download/0.21.0-rust/CProtonDriveSDK.xcframework.zip",
            checksum: "89c637b97582afd3ae0a06f27b570854d277ee952a997c19bb35e8208725cb83"
        ),
        .target(
            name: "ProtonDriveSDK",
            dependencies: [
