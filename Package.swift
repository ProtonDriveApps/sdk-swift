...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/ProtonDriveApps/sdk-swift/releases/download/0.15.1/CProtonDriveSDK.xcframework.zip",
            checksum: "9b46573f6500122482a6d2110c8881de562281ff147746bf2702139dfbd704c6"
        ),
        .target(
            name: "ProtonDriveSDK",
            dependencies: [
