...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/ProtonDriveApps/sdk-swift/releases/download/0.24.0-rust/CProtonDriveSDK.xcframework.zip",
            checksum: "9ddc41db8425dbe94399a900dc35fe9fefd4d59d74d9b07d83ce007ed831153d"
        ),
        .target(
            name: "ProtonDriveSDK",
            dependencies: [
