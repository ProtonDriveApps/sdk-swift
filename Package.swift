...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/ProtonDriveApps/sdk-swift/releases/download/0.19.0/CProtonDriveSDK.xcframework.zip",
            checksum: "8e151fcb836f6b3e789e805f002824c6dd3e8a49334d9a51a0583d98406d45a5"
        ),
        .target(
            name: "ProtonDriveSDK",
            dependencies: [
