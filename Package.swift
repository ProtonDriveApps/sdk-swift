...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/ProtonDriveApps/sdk-swift/releases/download/0.20.2/CProtonDriveSDK.xcframework.zip",
            checksum: "7df4e900371e11ecb454e280f9ad7bab02801fdca895f329c10db1ae8213a9af"
        ),
        .target(
            name: "ProtonDriveSDK",
            dependencies: [
