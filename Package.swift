...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/ProtonDriveApps/sdk-swift/releases/download/0.21.0/CProtonDriveSDK.xcframework.zip",
            checksum: "895b45b4c2c23a5e22a02616a05193d9f141d1ecda1ecd4ddb0b9816b701b258"
        ),
        .target(
            name: "ProtonDriveSDK",
            dependencies: [
