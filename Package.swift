...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/ProtonDriveApps/sdk-swift/releases/download/0.22.0-rust/CProtonDriveSDK.xcframework.zip",
            checksum: "55fbb5b797fda9b3a7b3ed516792c9755b829311197b405f432df60d2a1683cc"
        ),
        .target(
            name: "ProtonDriveSDK",
            dependencies: [
