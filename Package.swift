...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/ProtonDriveApps/sdk-swift/releases/download/0.20.2-rust/CProtonDriveSDK.xcframework.zip",
            checksum: "f9d734902b5b2affe9be415ad1fe57e17a3f1799af276adf3f7098629070834f"
        ),
        .target(
            name: "ProtonDriveSDK",
            dependencies: [
