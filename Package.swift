...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/ProtonDriveApps/sdk-swift/releases/download/0.16.0/CProtonDriveSDK.xcframework.zip",
            checksum: "88022710b1163b8076be14528cd9d3ca77905250fb287286cbf74c735e3fd0b8"
        ),
        .target(
            name: "ProtonDriveSDK",
            dependencies: [
