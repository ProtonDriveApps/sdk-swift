...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/ProtonDriveApps/sdk-swift/releases/download/0.24.0/CProtonDriveSDK.xcframework.zip",
            checksum: "709a40329e9d3ee928d653f2feac2669580582549aa2827e4d4af0a0ee3b3747"
        ),
        .target(
            name: "ProtonDriveSDK",
            dependencies: [
