...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/ProtonDriveApps/sdk-swift/releases/download/0.23.0/CProtonDriveSDK.xcframework.zip",
            checksum: "963d8175950af2de67cdb0bfa7b173ec26c6de7789f6cf4cd56648b0e2d664d2"
        ),
        .target(
            name: "ProtonDriveSDK",
            dependencies: [
