...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/ProtonDriveApps/sdk-swift/releases/download/0.20.0-rust/CProtonDriveSDK.xcframework.zip",
            checksum: "595992ad44f37401972b5240bf08b13a29f470430b29cbced889350a635e37b6"
        ),
        .target(
            name: "ProtonDriveSDK",
            dependencies: [
