...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/ProtonDriveApps/sdk-swift/releases/download/0.25.0-rust/CProtonDriveSDK.xcframework.zip",
            checksum: "a36786a43b4057baa6fbd2a66195877ee2efca48fe97f3a348d64e59570a5440"
        ),
        .target(
            name: "ProtonDriveSDK",
            dependencies: [
