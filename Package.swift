...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/ProtonDriveApps/sdk-swift/releases/download/0.15.0/CProtonDriveSDK.xcframework.zip",
            checksum: "5d87b74131401d86191a5381daaf5fdbf2ef9e4d3cd7bd6f12873a4a6f49b5c4"
        ),
        .target(
            name: "ProtonDriveSDK",
            dependencies: [
