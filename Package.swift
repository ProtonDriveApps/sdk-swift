...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/ProtonDriveApps/sdk-swift/releases/download/0.22.0/CProtonDriveSDK.xcframework.zip",
            checksum: "8ad556b56297e1479f63dfb4271fb8892b777591fc737770ab398e3ba65772db"
        ),
        .target(
            name: "ProtonDriveSDK",
            dependencies: [
