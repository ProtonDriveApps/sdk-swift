...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/ProtonDriveApps/sdk-swift/releases/download/0.25.0/CProtonDriveSDK.xcframework.zip",
            checksum: "214dde73bfe2c6a884f3aed092ea5e236a7c097b11862eb7eada74f9f3279098"
        ),
        .target(
            name: "ProtonDriveSDK",
            dependencies: [
