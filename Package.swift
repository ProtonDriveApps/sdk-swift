...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/ProtonDriveApps/sdk-swift/releases/download/0.18.1/CProtonDriveSDK.xcframework.zip",
            checksum: "9a3d69069a699b7cf6b3699cc58010b8a466f564afa56362ae125a4478f4c054"
        ),
        .target(
            name: "ProtonDriveSDK",
            dependencies: [
