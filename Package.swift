...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/ProtonDriveApps/sdk-swift/releases/download/0.18.0/CProtonDriveSDK.xcframework.zip",
            checksum: "5f7a62b911d4d3c408012d04000ed3fb0d7d4cc95cfcafc28ae6e28f65ba4484"
        ),
        .target(
            name: "ProtonDriveSDK",
            dependencies: [
