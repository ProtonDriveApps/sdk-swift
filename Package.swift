...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/ProtonDriveApps/sdk-swift/releases/download/0.17.1/CProtonDriveSDK.xcframework.zip",
            checksum: "dcff6fda12d1f35a0bfa9c6115b03234c2cdeeb31bb7f1db2feb4fd994bb040c"
        ),
        .target(
            name: "ProtonDriveSDK",
            dependencies: [
